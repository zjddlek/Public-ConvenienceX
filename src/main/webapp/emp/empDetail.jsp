		...
		<form action="mc" method="get">
			<div id="leftpicture">
				<div class="col-md-4 offset-md-1 my-3">
					<img src="/cx/upload/${vo.picture}" alt="" id="picture"
						name="picture" />
				</div>
			</div>
			<!-- 이부분 강사님께서 경로 지정해주심 -->
			...
			<div id="rightside">
				<div class="col-md-5 offset-md-1 my-3">
					<label for="username">사원명</label> <input type="text"
						class="form-control" name="ename" value="${vo.ename}" readonly />
				</div>

				<div class="col-md-5 offset-md-1 my-3">
					<label for="username">생년월일</label> <input type="text"
						class="form-control" name="date" value="${vo.date }" readonly />

				</div>
				<div class="col-md-5 offset-md-1 row my-3">
					<label for="username">전화번호</label> <input type="text"
						class="form-control" name="phone" value="${vo.phone }" readonly />
				</div>
			</div>
			...
			<div id="middle">
				<div class="row">
					<div class="col-md-3 offset-md-1 row my-3">
						<label for="username">아이디</label> <input type="text"
							class="form-control" name="id" value="${vo.id }" readonly />
					</div>

					<div class="col-md-3 offset-md-1 row my-3">
						<label for="username">비밀번호</label> <input type="password"
							class="form-control" name="pwd" value="${vo.pwd }" readonly />
					</div>
				</div>
				...
				<div class="row">
					<div class="col-md-7 offset-md-1 row my-3">
						<label for="username">이메일</label> <input type="text"
							class="form-control" name="email" value="${vo.email }" readonly />
					</div>
				...
				<div id="buttons">
					<div class="col-md-6 offset-md-4 pt-5 bt-5">
						...
						</a> <a href="mc?type=modify&empno=${vo.empno }&jobno=${vo.jobno}"> <input
