			...
			<div id="middle">		
				...
				<div class="col-md-6 offset-md-4 pt-5 bt-5">
					<a href="mc?type=emp"><input type="button"
						class="btn btn-success" value="목록" /></a> <a
						href="mc?type=modify&empno=${vo.empno }"><input type="button"
						class="btn btn-primary" value="수정" /></a> <a
						href="mc?type=delete&empno=${vo.empno }"><input type="button"
