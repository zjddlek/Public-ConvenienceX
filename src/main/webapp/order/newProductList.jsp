		...
		<table class="table table-striped table-hover table-sm">
			...
			<tr>
				<td colspan='2' style='text-align: end'>
					<nav aria-label="Page navigation">
						<ul class="pagination justify-content-center">
							<li class="page-item"><a class="page-link" href="mc?type=newProducts&sno=${svo.sno }&cp=1">첫 페이지로</a></li>
						</ul>
					</nav>
				</td>
					...
					<nav aria-label="Page navigation">
						<ul class="pagination justify-content-center">
							<c:if test="${currentPage > 1}">
								<li class="page-item"><a class="page-link" href="mc?type=newProducts&sno=${svo.sno }&cp=${currentPage -1 }">Previous</a></li>
							</c:if>
							<c:forEach var="i" begin="${startPage }" end="${endPage }">
								<li class="page-item"><a class="page-link" href="mc?type=newProducts&sno=${svo.sno }&cp=${i }">${i }</a></li>
							</c:forEach>
							<c:if test="${currentPage < totalPage}">
								<li class="page-item"><a class="page-link" href="mc?type=newProducts&sno=${svo.sno }&cp=${currentPage +1 }">Next</a></li>
							</c:if>
						</ul>
					</nav>
				</td>
				<td colspan='2'>
					<nav aria-label="Page navigation">
						<ul class="pagination justify-content-center">
							<li class="page-item"><a class="page-link" href="mc?type=newProducts&sno=${svo.sno }&cp=${totalPage }">마지막 페이지로</a></li>
						</ul>
					</nav>
				</td>
			</tr>
