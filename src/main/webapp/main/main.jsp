			...
			<nav class="navbar navbar-expand-lg">
				<div class="container-fluid">
					...
					<div class="collapse navbar-collapse" id="navbarNav">
						<ul class="navbar-nav">
							<li class="nav-item"><a class="nav-link" href="mc?type=main">메인
									페이지</a></li>
							<li class="nav-item"><a class="nav-link"
								href="mc?type=sales">판매 관리</a></li>
							<li class="nav-item"><a class="nav-link"
								href="mc?type=orders&sno=${svo.sno }">발주</a></li>
							<li class="nav-item"><a class="nav-link"
								href="mc?type=stock">재고관리</a></li>
							<li class="nav-item"><a class="nav-link"
								href="mc?type=calMain">정산 - 작업중</a></li>
							<li class="nav-item"><a class="nav-link"
								href="mc?type=dispose">폐기</a></li>
							<li class="nav-item"><a class="nav-link"
								href="mc?type=emp&sno=${svo.sno }&jobno=${vo.jobno }">인사관리</a></li>
							<li class="nav-item"><a class="nav-link"
								href="mc?type=workmain&sno=${svo.sno }">출퇴근</a></li>
							<li class="nav-item"><a class="nav-link" href="mc?type=etc">부대비용관리
									- 작업x</a></li>
